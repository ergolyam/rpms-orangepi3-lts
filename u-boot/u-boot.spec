...
BuildRequires:  bc bison flex gcc make openssl-devel python3 python3-devel python3-pyyaml python3-setuptools swig binutils-aarch64-linux-gnu gcc-aarch64-linux-gnu

%description
%{summary}

%prep
%autosetup -n u-boot-%{version} -a1 -p1
